...
* 0.6 - Fixed chart displaying (navigators comparison) for pages/posts in administration.

* 0.5 - Bug correction where the datas collection was stopped.

* 0.4 - Performance improvement. Added option personal referers. Added manual reset options.

* 0.3 - To stay realistic, now the plugin does not make comparison on the latest performance value from one navigator (robots always wins...). Now the plugin register simply the latest value and displays it.

* 0.2 - Exclude the only one user_meta from the divisor option...